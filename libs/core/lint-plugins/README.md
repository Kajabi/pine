...
| Rule | Purpose |
|------|---------|
| `pine-design-system/no-hardcoded-colors` | Blocks hardcoded colors (hex, rgb, rgba, hsl, hsla), suggests closest Pine token |
...
| File | Description |
|------|-------------|
| `pine-color-utils.cjs` | Color parsing (hex, rgb, rgba, hsl, hsla) and distance algorithm for token matching |
| `stylelint-plugin-pine-colors.cjs` | Catches hardcoded colors (hex, rgb, rgba, hsl, hsla) |
