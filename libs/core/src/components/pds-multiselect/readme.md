...
| `pdsMultiselectDismiss`     | Emitted when the dropdown is dismissed via escape key or click outside (not when closed by selection). Equivalent to Sage's onEscapeHook. | `CustomEvent<void>`                              |
