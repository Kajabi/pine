...
| `placeholder`              | `placeholder`           | Placeholder text for the input field. When unset, falls back to the localized default (`pds-multiselect.placeholder` via PineI18n, "Select...").                                                                                                           | `string`                               | `undefined`      |
| `required`                 | `required`              | If true, the multiselect is required.                                                                                                                                                                                                                      | `boolean`                              | `false`          |
| `searchPlaceholder`        | `search-placeholder`    | Placeholder text for the search input inside the dropdown panel. When unset, falls back to the localized default (`pds-multiselect.searchPlaceholder` via PineI18n, "Find...").                                                                            | `string`                               | `undefined`      |
