...
| `itemRemovedLabel`         | `item-removed-label`         | Screen-reader announcement when an item is removed. `{item}` is interpolated.                                                                                                                                                                              | `string`                               | `'{item} removed'` |
...
| `placeholder`              | `placeholder`                | Placeholder text for the input field. Pass a translated string to localize.                                                                                                                                                                                | `string`                               | `'Select...'`      |
| `required`                 | `required`                   | If true, the multiselect is required.                                                                                                                                                                                                                      | `boolean`                              | `false`            |
| `searchOptionsLabel`       | `search-options-label`       | Accessible label for the search input. Pass a translated string to localize.                                                                                                                                                                               | `string`                               | `'Search options'` |
| `searchPlaceholder`        | `search-placeholder`         | Placeholder text for the search input inside the dropdown panel. Pass a translated string to localize.                                                                                                                                                     | `string`                               | `'Find...'`        |
| `selectedCountLabelOne`    | `selected-count-label-one`   | Singular form of the selected-count trigger text. `{count}` is interpolated.                                                                                                                                                                               | `string`                               | `'{count} item'`   |
| `selectedCountLabelOther`  | `selected-count-label-other` | Plural form of the selected-count trigger text (also the fallback for locales with additional plural categories). `{count}` is interpolated.                                                                                                               | `string`                               | `'{count} items'`  |
...
| `selectedItemsLabel`       | `selected-items-label`       | Accessible label for the selected-items region. Pass a translated string to localize.                                                                                                                                                                      | `string`                               | `'Selected items'` |
