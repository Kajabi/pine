...
import * as stories from '../stories/pds-text.stories.js';
...
<DocCanvas
  mdxSource={{
    react: `
      <PdsText style={{backgroundColor: 'var(--pine-color-background-inverse-app)', paddingInline: '8px'}} color="primary" tag="h5">Zebstrika</PdsText>
    ...
    `,
    webComponent: `
      <pds-text style="background-color: var(--pine-color-background-inverse-app); padding-inline: 8px" color="primary" tag="h5">Zebstrika</pds-text>
  ...
  <pds-text style={{backgroundColor: 'var(--pine-color-background-inverse-app)', paddingInline: '8px'}} color="primary" tag="h5">Zebstrika</pds-text>
  <pds-text color="secondary" tag="h5">Pangoro</pds-text>
  <pds-text color="neutral" tag="h5">Urshifu</pds-text>
  <pds-text color="accent" tag="h5">Sableye</pds-text>
  <pds-text color="danger" tag="h5">Arcanine</pds-text>
