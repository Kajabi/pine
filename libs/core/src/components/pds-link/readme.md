...
| ------------------- | ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- | ----------- |
| `active`            | `active`         | Marks the link as the current/active navigation item — for tab strips and nav rails built from links. Applies the active treatment (persistent underline + strong text) and sets `aria-current="page"`.                    | `boolean`                                         | `false`     |
