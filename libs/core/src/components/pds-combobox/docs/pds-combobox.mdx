...
<DocCanvas client:only
  mdxSource={{
    webComponent: `<pds-combobox component-id="chip-draft" label="Status" placeholder="Draft" trigger="chip" mode="select-only" custom-option-layouts="true" custom-trigger-content="true">
  ...
  <option value="archived" data-layout><pds-chip sentiment="warning" dot>Archived</pds-chip></option>
    ...
    react: `<PdsCombobox componentId="chip-draft" label="Status" placeholder="Draft" trigger="chip" mode="select-only" customOptionLayouts="true" customTriggerContent="true">
...
<DocCanvas client:only
  mdxSource={{
    webComponent: `<pds-combobox component-id="chip-icon" label="Status with Icon" placeholder="Select status" trigger="chip" chip-sentiment="info" chip-icon="info-circle" mode="select-only" custom-trigger-content="true" custom-option-layouts="true">
  <pds-chip slot="trigger-content" sentiment="info" icon="info-circle" variant="dropdown">Status</pds-chip>
  ...
  <option value="archived" data-layout><pds-chip sentiment="warning" icon="warning">Archived</pds-chip></option>
    ...
    react: `<PdsCombobox componentId="chip-icon" label="Status with Icon" placeholder="Select status" trigger="chip" chipSentiment="info" chipIcon="info-circle" mode="select-only" customTriggerContent="true" customOptionLayouts="true">
  <PdsChip slot="trigger-content" sentiment="info" icon="info-circle" variant="dropdown">Status</PdsChip>
  <option value="draft" selected data-layout><PdsChip sentiment="neutral" icon="info-circle">Draft</PdsChip></option>
  <option value="published" data-layout><PdsChip sentiment="success" icon="check">Published</PdsChip></option>
  <option value="archived" data-layout><PdsChip sentiment="warning" icon="warning">Archived</PdsChip></option>
</PdsCombobox>`,
  }}
>
  <pds-combobox component-id="chip-icon" label="Status with Icon" placeholder="Select status" trigger="chip" chip-sentiment="info" chip-icon="info-circle" mode="select-only" custom-trigger-content="true" custom-option-layouts="true">
    <pds-chip slot="trigger-content" sentiment="info" icon="info-circle" variant="dropdown">Status</pds-chip>
    <option value="draft" selected data-layout><pds-chip sentiment="neutral" icon="info-circle">Draft</pds-chip></option>
    <option value="published" data-layout><pds-chip sentiment="success" icon="check">Published</pds-chip></option>
    <option value="archived" data-layout><pds-chip sentiment="warning" icon="warning">Archived</pds-chip></option>
