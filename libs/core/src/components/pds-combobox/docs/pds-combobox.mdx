...
<DocCanvas client:only
  mdxSource={{
    webComponent: `<pds-combobox component-id="chip-draft" label="Status" trigger="chip" mode="select-only">
  <option value="draft" selected chip-sentiment="neutral" chip-dot="true">Draft</option>
  ...
  <option value="archived" chip-sentiment="warning" chip-dot="true">Archived</option>
    ...
    react: `<PdsCombobox componentId="chip-draft" label="Status" trigger="chip" mode="select-only">
  <option value="draft" selected chip-sentiment="neutral" chip-dot="true">Draft</option>
  <option value="published" chip-sentiment="success" chip-dot="true">Published</option>
  <option value="archived" chip-sentiment="warning" chip-dot="true">Archived</option>
</PdsCombobox>`,
...
>
  <pds-combobox component-id="chip-draft" label="Status" trigger="chip" mode="select-only">
    <option value="draft" selected chip-sentiment="neutral" chip-dot="true">Draft</option>
    <option value="published" chip-sentiment="success" chip-dot="true">Published</option>
    <option value="archived" chip-sentiment="warning" chip-dot="true">Archived</option>
  </pds-combobox>
...
<DocCanvas client:only
  mdxSource={{
    webComponent: `<pds-combobox component-id="chip-icon-auto" label="Priority Level" trigger="chip" mode="select-only">
  ...
  <option value="critical" chip-sentiment="danger" chip-icon="danger">Critical</option>
    ...
    react: `<PdsCombobox componentId="chip-icon-auto" label="Priority Level" trigger="chip" mode="select-only">
  <option value="low" chip-sentiment="info" chip-icon="info-circle">Low</option>
  <option value="medium" chip-sentiment="warning" chip-icon="warning">Medium</option>
  <option value="high" selected chip-sentiment="danger" chip-icon="warning">High</option>
  <option value="critical" chip-sentiment="danger" chip-icon="danger">Critical</option>
...
>
  <pds-combobox component-id="chip-icon-auto" label="Priority Level" trigger="chip" mode="select-only">
    <option value="low" chip-sentiment="info" chip-icon="info-circle">Low</option>
    <option value="medium" chip-sentiment="warning" chip-icon="warning">Medium</option>
    <option value="high" selected chip-sentiment="danger" chip-icon="warning">High</option>
    <option value="critical" chip-sentiment="danger" chip-icon="danger">Critical</option>
