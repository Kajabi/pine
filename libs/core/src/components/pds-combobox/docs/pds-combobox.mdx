...
<DocCanvas client:only
  ...
  <pds-combobox component-id="chip-draft" label="Status" placeholder="Draft" trigger="chip" mode="select-only" custom-option-layouts="true" custom-trigger-content="true">
    <pds-chip slot="trigger-content" sentiment="neutral" dot>Draft</pds-chip>
  ...
  <pds-combobox component-id="chip-published" label="Status" placeholder="Published" trigger="chip" mode="select-only" custom-option-layouts="true" custom-trigger-content="true">
    <pds-chip slot="trigger-content" sentiment="success" dot>Published</pds-chip>
  ...
  <pds-combobox component-id="chip-drip" label="Status" placeholder="Drip" trigger="chip" mode="select-only" custom-option-layouts="true" custom-trigger-content="true">
    <pds-chip slot="trigger-content" sentiment="info" dot>Drip</pds-chip>
    <option value="draft" data-layout><pds-chip sentiment="neutral" dot>Draft</pds-chip></option>
  ...
  <pds-combobox component-id="chip-locked" label="Status" placeholder="Locked" trigger="chip" mode="select-only" custom-option-layouts="true" custom-trigger-content="true">
    <pds-chip slot="trigger-content" sentiment="accent" dot>Locked</pds-chip>
  ...
  <PdsCombobox componentId="chip-draft" label="Status" placeholder="Draft" trigger="chip" mode="select-only" customOptionLayouts={true} customTriggerContent={true}>
    <PdsChip slot="trigger-content" sentiment="neutral" dot>Draft</PdsChip>
  ...
  <PdsCombobox componentId="chip-published" label="Status" placeholder="Published" trigger="chip" mode="select-only" customOptionLayouts={true} customTriggerContent={true}>
    <PdsChip slot="trigger-content" sentiment="success" dot>Published</PdsChip>
  ...
  <PdsCombobox componentId="chip-drip" label="Status" placeholder="Drip" trigger="chip" mode="select-only" customOptionLayouts={true} customTriggerContent={true}>
    <PdsChip slot="trigger-content" sentiment="info" dot>Drip</PdsChip>
    <option value="draft" data-layout><PdsChip sentiment="neutral" dot>Draft</PdsChip></option>
  ...
  <PdsCombobox componentId="chip-locked" label="Status" placeholder="Locked" trigger="chip" mode="select-only" customOptionLayouts={true} customTriggerContent={true}>
    <PdsChip slot="trigger-content" sentiment="accent" dot>Locked</PdsChip>
