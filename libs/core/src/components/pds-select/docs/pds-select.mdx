...
import * as stories from '../stories/pds-select.stories.js';
...
Applies accent styling to the select field with a purple background, border, text, and icon color to draw attention to important fields.

<DocCanvas
 
  mdxSource={{
    react: `
      <PdsSelect componentId="pds-select-highlight-example" highlight="true" label="Name" name="name" value="paul">
        <option value="paul">Paul McCartney</option>
        <option value="john">John Lennon</option>
        <option value="george">George Harrison</option>
        <option value="ringo">Ringo Starr</option>
    ...
    webComponent: `
      <pds-select component-id="pds-select-highlight-example" highlight="true" label="Name" name="name" value="paul">
        <option value="paul">Paul McCartney</option>
        <option value="john">John Lennon</option>
        <option value="george">George Harrison</option>
        <option value="ringo">Ringo Starr</option>
