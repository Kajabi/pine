...
| `icon`         | `icon`          | Displays a leading icon in the button.                                                                                                                                    | `string`                                                                              | `null`      |
...
| `trailingIcon` | `trailing-icon` | Displays a trailing icon in the button. Does not render when iconOnly is true.                                                                                            | `string`                                                                              | `null`      |
