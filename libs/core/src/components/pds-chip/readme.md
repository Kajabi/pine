...
| `large`       | `large`        | Indicates whether the chip should be displayed in a larger size. | `boolean`                                                               | `false`     |
...
| ------------------ | ---------------------------------------------------------------------- | ------------------ |
| `pdsTagCloseClick` | Emits an event when the close button is clicked on a tag variant chip. | `CustomEvent<any>` |
