...
| `dismissLabel`             | `dismiss-label` | Accessible label for the dismiss button. Overrides the localized default (`pds-toast.dismiss` via PineI18n) for this instance only.                     | `string`                             | `undefined` |
