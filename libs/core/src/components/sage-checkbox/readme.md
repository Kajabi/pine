...
| `indeterminate` | `indeterminate` | Whether or not checkbox should display as indeterminate. Prop is for visual styling only. Only JavaScript can et the objects `indeterminate` property. See [MDN Web Docs](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/checkbox#indeterminate_state_checkboxes) | `boolean` | `undefined` |
