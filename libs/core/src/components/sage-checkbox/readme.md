...
| --------------- | ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- | ----------- |
| `checked`       | `checked`        | Determines whether or not the checkbox is checked.                                                                                                                                                                                                        | `boolean` | `undefined` |
| `componentId`   | `component-id`   | String used for checkbox `id` attribute and label `for` attribute.                                                                                                                                                                                        | `string`  | `undefined` |
| `disabled`      | `disabled`       | Determines whether or not the checkbox is disabled.                                                                                                                                                                                                       | `boolean` | `undefined` |
...
| `invalid`       | `invalid`        | Determines whether or not the checkbox is invalid.                                                                                                                                                                                                        | `boolean` | `undefined` |
...
| `required`      | `required`       | Determines whether or not the checkbox is required.                                                                                                                                                                                                       | `boolean` | `undefined` |
