...
| Name                                | Description                                   |
| ----------------------------------- | --------------------------------------------- |
| `--background-color-color`          | Background color of the input                 |
| `--background-color-color-disabled` | Background color of a disabled input          |
...
| `--hint-margin-block-start`         | Top margin of the hint                        |
...
| `--label-margin-block-end`          | Bottom margin of the label                    |
