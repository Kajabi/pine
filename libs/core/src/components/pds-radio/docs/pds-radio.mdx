...
<DocArgsTable componentName='pds-radio' />
...
<DocCanvas client:only mdxSource={{
  react: `<PdsRadio componentId="checked" label="Label" checked />`,
...
<DocCanvas client:only mdxSource={{
  react: `<PdsRadio component-id="disabled" label="Label" disabled />`,
...
<DocCanvas client:only mdxSource={{
  react: `<PdsRadio componentId="message1" label="Label" helper-message="This is short message text." />`,
...
<DocCanvas client:only mdxSource={{
  react: `<PdsRadio componentId="invalid" label="Label" invalid error-message="This is a short error message" />`,
...
<DocCanvas client:only mdxSource={{
  react: `<div>
  <PdsRadio componentId="default1" label="Label" name="radio" checked />
