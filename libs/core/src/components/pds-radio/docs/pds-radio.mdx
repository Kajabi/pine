...
You can provide images by using the `image` slot.
...
<DocCanvas client:only mdxSource={{
  ...
  <PdsRadio
    ...
    name="avatar-selection"
    value="jane"
    imageUrl="https://via.placeholder.com/24x24/10b981/ffffff?text=JS"
  ...
  <PdsRadio
    ...
    name="avatar-selection"
    value="mike"
    imageUrl="https://via.placeholder.com/24x24/f59e0b/ffffff?text=MJ"
