...
describe('sage-tabs', () => {
  it('renders', async () => {
    ...
    await page.setContent(`
      <sage-tabs active-tab-name="two" tablist-label="test label" component-id="test" variant="primary">
        <sage-tab name="one">Test 1</sage-tab>
        <sage-tab name="two">Test 2</sage-tab>
  ...
  it('renders availability variant', async () => {
    const page = await newE2EPage();
    await page.setContent(`
      <sage-tabs active-tab-name="two" tablist-label="test label" component-id="test" variant="availability">
        <sage-tab name="one">Test 1</sage-tab>
        <sage-tab name="two">Test 2</sage-tab>
        <sage-tabpanel name="one">Content 1</sage-tabpanel>
        <sage-tabpanel name="two">Content 2</sage-tabpanel>
  ...
  it('renders filter variant', async () => {
    const page = await newE2EPage();
    await page.setContent(`
      <sage-tabs active-tab-name="two" tablist-label="test label" component-id="test" variant="filter">
        <sage-tab name="one">Test 1</sage-tab>
        <sage-tab name="two">Test 2</sage-tab>
        <sage-tabpanel name="one">Content 1</sage-tabpanel>
        <sage-tabpanel name="two">Content 2</sage-tabpanel>
  ...
  it('renders passed activeTabName on page load', async () => {
    const page = await newE2EPage();
    await page.setContent(`
      <sage-tabs active-tab-name="two" tablist-label="test label" component-id="testthree" variant="primary">
        <sage-tab name="one">Test 1</sage-tab>
        <sage-tab name="two">Test 2</sage-tab>
        <sage-tabpanel name="one">Content 1</sage-tabpanel>
        <sage-tabpanel name="two">Content 2</sage-tabpanel>
    ...
    `);
    const expectedActiveButton = await page.find(`sage-tab[name="two"] > button`);
    expect(expectedActiveButton.getAttribute('aria-selected')).toMatch("true");
    const expectedActivePanel = await page.find(`sage-tabpanel[name="two"] > div`);
  ...
  it('renders new activeTabName on button click', async () => {
    const page = await newE2EPage();
    await page.setContent(`
      <sage-tabs active-tab-name="two" tablist-label="test label" component-id="test3" variant="primary">
        <sage-tab name="one">Test 1</sage-tab>
        <sage-tab name="two">Test 2</sage-tab>
        <sage-tabpanel name="one">Content 1</sage-tabpanel>
        <sage-tabpanel name="two">Content 2</sage-tabpanel>
    ...
    `);
    const inactiveTabButton = await page.find(`sage-tab[name="one"] > button`);
    const event = await page.spyOnEvent('tabClick');
    inactiveTabButton.click();
    await page.waitForChanges();
    expect(event).toHaveReceivedEvent();
    const expectedActiveButton = await page.find(`sage-tab[name="one"] > button`);
    expect(expectedActiveButton.getAttribute('aria-selected')).toMatch("true");
    const expectedActivePanel = await page.find(`sage-tabpanel[name="one"] > div`);
    expect(expectedActivePanel).toHaveClass('is-active');
  });
  ...
  it('renders new activeTabName when arrows move focus to right', async () => {
    ...
    `);
    // Click inactive tab
    let tab = await page.find('sage-tab[name="one"] > button');
    tab.click();
    await page.waitForChanges();
  ...
  it('renders new activeTab when arrows move focus to left', async () => {
    const page = await newE2EPage();
    await page.setContent(`
      <sage-tabs active-tab-name="one" tablist-label="test label" component-id="test3" variant="primary">
        <sage-tab name="one">Test 1</sage-tab>
        <sage-tab name="two">Test 2</sage-tab>
        <sage-tabpanel name="one">Content 1</sage-tabpanel>
        <sage-tabpanel name="two">Content 2</sage-tabpanel>
    ...
    `);
    // Click inactive tab
    let tab = await page.find('sage-tab[name="two"] > button');
    tab.click();
    await page.waitForChanges();
  ...
  it('renders new activeTab when Home and End keys are pressed', async () => {
    const page = await newE2EPage();
    await page.setContent(`
      <sage-tabs active-tab-name="one" tablist-label="test label" component-id="test4" variant="primary">
        <sage-tab name="one">Test 1</sage-tab>
        <sage-tab name="two">Test 2</sage-tab>
        <sage-tab name="three">Test 2</sage-tab>
        <sage-tabpanel name="one">Content 1</sage-tabpanel>
        <sage-tabpanel name="two">Content 2</sage-tabpanel>
        <sage-tabpanel name="three">Content 2</sage-tabpanel>
      </sage-tabs>
    `);
    ...
    tab = await page.find('sage-tab[name="three"] > button');
    expect(tab.getAttribute('aria-selected')).toMatch("true");
  });
  ...
  it('renders a11y correctly', async () => {
    const page = await newE2EPage();
    await page.setContent(`
      <sage-tabs active-tab-name="two" tablist-label="test label" component-id="test4" variant="primary">
        <sage-tab name="one">Test 1</sage-tab>
        <sage-tab name="two">Test 2</sage-tab>
        <sage-tabpanel name="two">Content 2</sage-tabpanel>
        <sage-tabpanel name="one">Content 1</sage-tabpanel>
    ...
    let tabpanel = await page.find('sage-tabpanel[name="two"] > div');
    ...
    tabpanel = await page.find('sage-tabpanel[name="one"] > div');
    ...
    tabpanel = await page.find('sage-tabpanel[name="two"] > div');
    expect(tabpanel.getAttribute('aria-labelledby')).toMatch("two");
    expect(tabpanel.getAttribute('role')).toMatch("tabpanel");
