...
| `triggerLabel` | `trigger-label` | Accessible label for the dropdown trigger button. Overrides the localized default (`pds-avatar.trigger` via PineI18n) for this instance only. | `string`                | `undefined`  |
