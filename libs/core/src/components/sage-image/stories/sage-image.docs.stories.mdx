...
import * as stories from './sage-image.stories.js';

<Meta title="components/Image" component="sage-image" argTypes={extractArgTypes('sage-image')} />
...
<Canvas>
  <sage-image src="//source.unsplash.com/320x180" alt="Random Unsplash"></sage-image>
</Canvas>
...
<Canvas>
  <sage-image alt="Random Unsplash" sizes="(max-width: 450px) 150px, 600px" src="//source.unsplash.com/600x200" srcset="//source.unsplash.com/150x150 400w, //source.unsplash.com/600x200"></sage-image>
</Canvas>
