...
| `disabled`                 | `disabled`     | Determines whether or not the sortable is disabled.                 | `boolean`           | `false`     |
| `dividers`                 | `dividers`     | Determines whether `sortable` items should be divided with border.  | `boolean`           | `false`     |
