...
<Meta title="components/Image" component="pds-image" argTypes={extractArgTypes('pds-image')} />
...
<Canvas>
  <pds-image src="//source.unsplash.com/320x180" alt="Random Unsplash"></pds-image>
</Canvas>
...
<Story story={stories.SizesAndSrcset} />

<Canvas>
  <pds-image alt="Random Unsplash" sizes="(max-width: 450px) 150px, 600px" src="//source.unsplash.com/600x200" srcset="//source.unsplash.com/150x150 400w, //source.unsplash.com/600x200"></pds-image>
</Canvas>
