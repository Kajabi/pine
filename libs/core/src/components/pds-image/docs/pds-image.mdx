...
<DocArgsTable componentName="pds-image" />
...
<DocCanvas client:only
  mdxSource={{
    react: '<PdsImage src="//source.unsplash.com/random" alt="Random Unsplash"></PdsImage>',
    webComponent: '<pds-image src="//source.unsplash.com/random" alt="Random Unsplash"></pds-image>'
}}>
