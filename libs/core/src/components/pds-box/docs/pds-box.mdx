...
- `gap`: Spacing between items (with responsive variants: `gap-xs`, `gap-sm`, `gap-md`, `gap-lg`, `gap-xl`)
...
- `align-self`: Individual box alignment within container (with responsive variants: `align-self-xs`, `align-self-sm`, `align-self-md`, `align-self-lg`, `align-self-xl`)
- `padding`: Internal spacing (with responsive variants: `padding-xs`, `padding-sm`, `padding-md`, `padding-lg`, `padding-xl`)
- `padding-block-start`, `padding-block-end`, `padding-inline-start`, `padding-inline-end`: Directional padding (with responsive variants for each)
- `margin-block-start`, `margin-block-end`, `margin-inline-start`, `margin-inline-end`: Directional margins (with responsive variants for each)
- `wrap`: Flex wrap behavior (with responsive variants: `wrap-xs`, `wrap-sm`, `wrap-md`, `wrap-lg`, `wrap-xl`)
- `auto`: Auto-sizing behavior (with responsive variants: `auto-xs`, `auto-sm`, `auto-md`, `auto-lg`, `auto-xl`)
- `fit`: Full-width behavior (with responsive variants: `fit-xs`, `fit-sm`, `fit-md`, `fit-lg`, `fit-xl`)

### Responsive Breakpoints

All responsive properties follow the same breakpoint system:

- **Base (no suffix)**: Applies to all screen sizes unless overridden
- **XS (`-xs`)**: 0-575px (mobile phones)
- **SM (`-sm`)**: 576px and up (tablets)
- **MD (`-md`)**: 768px and up (small desktops)
- **LG (`-lg`)**: 992px and up (desktops)
- **XL (`-xl`)**: 1200px and up (large desktops)

**Examples:**
- `justify-content="center"` - Center on all screen sizes
- `justify-content="start" justify-content-md="center"` - Start on mobile, center on desktop
- `align-items="stretch" align-items-lg="start"` - Stretch on mobile/tablet, start on desktop
- `gap="xs" gap-md="lg"` - Small gap on mobile, large gap on desktop
- `padding="sm" padding-lg="xl"` - Small padding on mobile, extra large on desktop
- `wrap="false" wrap-md="true"` - No wrap on mobile, wrap on desktop
- `auto="true" auto-lg="false"` - Auto-size on mobile, fixed size on desktop
