...
#### Responsive Breakpoints for Align Self

- **Base (`align-self`)**: Applies to all screen sizes unless overridden
- **XS (`align-self-xs`)**: 0-575px (mobile)
- **SM (`align-self-sm`)**: 576px and up (tablets)
- **MD (`align-self-md`)**: 768px and up (small desktops)
- **LG (`align-self-lg`)**: 992px and up (desktops)
- **XL (`align-self-xl`)**: 1200px and up (large desktops)
