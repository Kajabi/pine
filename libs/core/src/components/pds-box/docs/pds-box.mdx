...
<DocCanvas client:only
  mdxSource={{
    react: `<PdsBox wrap="wrap" gap="sm" style={{width: '300px', border: '1px solid #ccc'}}>
  ...
  <PdsBox border="true" padding="sm">Item 5</PdsBox>
    ...
    webComponent: `<pds-box wrap="wrap" gap="sm" style="width: 300px; border: 1px solid #ccc;">
  ...
  <pds-box border="true" wrap="wrap" gap="sm" min-width="300px" >
    <pds-box border="true" padding="sm">Item 1</pds-box>
    <pds-box border="true" padding="sm">Item 2</pds-box>
    <pds-box border="true" padding="sm">Item 3</pds-box>
    <pds-box border="true" padding="sm">Item 4</pds-box>
...
#### Wrap Options
- `nowrap` (default): Items stay on one line and may overflow
...
<DocCanvas client:only
  mdxSource={{
    react: `
  <PdsBox wrap="nowrap" gap="sm" min-width="250px">
...
`,
    webComponent: `<pds-box wrap="nowrap" gap="sm" min-width="250px">
  ...
  <div>
    ...
    <pds-box border="true" wrap="nowrap" gap="sm" min-width="250px">
      <pds-box border="true" padding="sm">Long Item 1</pds-box>
      <pds-box border="true" padding="sm">Long Item 2</pds-box>
      <pds-box border="true" padding="sm">Long Item 3</pds-box>
    </pds-box>
...
<DocCanvas client:only
  mdxSource={{
    react: `<PdsBox wrap="wrap" gap="sm" min-width="250px">
    <PdsBox border="true" padding="sm">Long Item 1</PdsBox>
    <PdsBox border="true" padding="sm">Long Item 2</PdsBox>
    <PdsBox border="true" padding="sm">Long Item 3</PdsBox>
  </PdsBox>`,
    webComponent: `<pds-box wrap="wrap" gap="sm" min-width="250px">
    <pds-box border="true" padding="sm">Long Item 1</pds-box>
    <pds-box border="true" padding="sm">Long Item 2</pds-box>
    <pds-box border="true" padding="sm">Long Item 3</pds-box>
  </pds-box>`
}}>
<pds-box border="true" wrap="wrap" gap="sm" min-width="250px">
  <pds-box border="true" padding="sm">Long Item 1</pds-box>
  <pds-box border="true" padding="sm">Long Item 2</pds-box>
  <pds-box border="true" padding="sm">Long Item 3</pds-box>
</pds-box>
