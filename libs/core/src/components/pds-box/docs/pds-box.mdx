...
<DocCanvas client:only
  ...
  <button onClick={() => console.log('skdfn')}><pds-box>Non veniam ut id voluptate deserunt incididunt ut elit ipsum magna labore. Laborum qui laboris tempor est sint amet est. Consectetur adipisicing nostrud culpa reprehenderit tempor aliquip officia. Dolore cupidatat quis eu veniam <pds-link href="https://github.com/" external="true">Github</pds-link> cillum qui labore ut in veniam dolore ut. Ipsum pariatur pariatur anim quis ut dolore irure exercitation minim quis qui. In exercitation velit anim cillum aute magna nostrud deserunt nulla. Aliquip labore sit elit non enim est culpa non eu dolor ut incididunt Lorem.</pds-box></button>
</DocCanvas>
