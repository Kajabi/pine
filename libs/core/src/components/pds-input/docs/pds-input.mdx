...
import * as stories from '../stories/pds-input.stories.js';
...
<DocCanvas
  mdxSource={{
    react: `<PdsInput componentId="pds-input-prefix-suffix-text" label="URL" type="text" value="">
      <PdsText color="var(--pine-color-text-muted)" slot="prefix">https://</PdsText>
      <PdsText color="var(--pine-color-text-muted)" slot="suffix">mykajabi.com</PdsText>
    </PdsInput>`,
    webComponent: `<pds-input component-id="pds-input-prefix-suffix-text" label="URL" type="text" value="">
      <pds-text color="var(--pine-color-text-muted)" slot="prefix">https://</pds-text>
      <pds-text color="var(--pine-color-text-muted)" slot="suffix">mykajabi.com</pds-text>
    </pds-input>`
  }}>
