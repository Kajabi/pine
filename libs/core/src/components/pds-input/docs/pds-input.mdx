...
<DocCanvas client:only
  mdxSource={{
    react: '<PdsInput componentId="pds-input-highlight-example" label="Label" type="text" highlight value="This input is highlighted"></PdsInput>',
    webComponent: '<pds-input component-id="pds-input-highlight-example" label="Label" type="text" highlight value="This input is highlighted"></pds-input>'
}}>
  <pds-input component-id="pds-input-highlight-example" label="Label" type="text" highlight value="This input is highlighted"></pds-input>
</DocCanvas>
...
<DocCanvas client:only
  mdxSource={{
    react: `<PdsInput componentId="pds-input-prefix-suffix-text" label="URL" type="text" value="">
      <PdsText color="var(--pine-color-grey-700)" slot="prefix">https://</PdsText>
      <PdsText color="var(--pine-color-grey-700)" slot="suffix">mykajabi.com</PdsText>
    </PdsInput>`,
    webComponent: `<pds-input component-id="pds-input-prefix-suffix-text" label="URL" type="text" value="">
      <pds-text color="var(--pine-color-grey-700)" slot="prefix">https://</pds-text>
      <pds-text color="var(--pine-color-grey-700)" slot="suffix">mykajabi.com</pds-text>
    </pds-input>`
  }}>
