...
| `disabled`                 | `disabled`       | If true, the input field is disabled.                                                                        | `boolean` | `undefined` |
...
| `invalid`                  | `invalid`        | If true, the input field is invalid.                                                                         | `boolean` | `undefined` |
...
| `readonly`                 | `readonly`       | If true, the input field is readonly.                                                                        | `boolean` | `undefined` |
