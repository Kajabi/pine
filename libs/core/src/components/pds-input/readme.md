...
| `hideAppendOnEmpty`        | `hide-append-on-empty`  | If true, hide the append when the input is empty                                                                      | `boolean`          | `false`     |
| `hidePrefixOnEmpty`        | `hide-prefix-on-empty`  | If true, hide the prefix when the input is empty                                                                      | `boolean`          | `false`     |
| `hidePrependOnEmpty`       | `hide-prepend-on-empty` | If true, hide the prepend when the input is empty                                                                     | `boolean`          | `false`     |
| `hideSuffixOnEmpty`        | `hide-suffix-on-empty`  | If true, hide the suffix when the input is empty                                                                      | `boolean`          | `false`     |
