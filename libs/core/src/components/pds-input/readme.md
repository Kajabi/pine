...
| `max`                      | `max`            | Specifies the maximum value for the input field.                                                                      | `number \| string` | `undefined` |
| `maxlength`                | `maxlength`      | Specifies the maximum number of characters allowed in the input field.                                                | `number \| string` | `undefined` |
| `min`                      | `min`            | Specifies the minimum value for the input field.                                                                      | `number \| string` | `undefined` |
| `minlength`                | `minlength`      | Specifies the minimum number of characters allowed in the input field.                                                | `number \| string` | `undefined` |
...
| `step`                     | `step`           | Works with the `min` and `max` attributes to define increments for the input field.                                   | `number \| string` | `undefined` |
