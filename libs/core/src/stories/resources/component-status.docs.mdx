...
<pds-box border border-radius="sm" fit>
  <pds-table component-id="component-status-table" responsive>
    ...
    <pds-table-body>
      ...
      <pds-table-row>
        <pds-table-cell><code>pds-skeleton</code></pds-table-cell>
        <pds-table-cell>Beta</pds-table-cell>
        <pds-table-cell>New component; variant set and theme fill values still open.</pds-table-cell>
      </pds-table-row>
      <pds-table-row>
