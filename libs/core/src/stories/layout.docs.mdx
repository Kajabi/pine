...
`}>
  ...
  >
    <pds-box size-md="6" size-lg="4" size-xl="3">Item 1</pds-box>
    <pds-box size-md="6" size-lg="4" size-xl="3">Item 2</pds-box>
    <pds-box size-md="6" size-lg="4" size-xl="3">Item 3</pds-box>
  </pds-row>
</Canvas>
...
<Canvas mdxSource={`
<pds-row>
  <pds-box size-xs="0" size-sm="0" size-lg="6">Larger screen content</pds-box>
  <pds-box size-md="6" size-lg="0">Small screen content</pds-box>
</pds-row>
`}>
  <pds-row>
    <pds-box size-xs="0" size-sm="0" size-lg="12">Larger screen content</pds-box>
    <pds-box size-md="12" size-lg="0">Small screen content</pds-box>
  </pds-row>
</Canvas>
