...
# Layout
The Layout system is driven by `pds-box` and `pds-layout-row`. 
...
## `pds-layout-row`
The `pds-layout-row` component is designed to create horizontal rows that contain a set of columns that are capable of altering sizes at different breakpoints. `pds-box`s that don't exist in `pds-layout-row`s will not contain responsive functionality.
...
<pds-box display="block">
  <pds-layout-row col-gap="1rem">
    ...
    <pds-box direction="column" size-md="8">
      <pds-box class="pds-spacing-bottom-md" bordered direction="column" padding="md" border-radius="lg">
      ...
      <pds-box bordered direction="column" padding="md" border-radius="lg">
        <h3>Transcription</h3>
...
The maximum file size for a transcript is 2 MB. Supported file format: txt</p>
    ...
    <pds-box direction="column" size-md="4">
      {/* box 1 */}
      <pds-box class="pds-spacing-bottom-md" bordered direction="column" flex="none" padding="md" border-radius="lg">
      ...
      {/* box 2 */}
      <pds-box class="pds-spacing-bottom-md" bordered display="block" flex="none" padding="md" border-radius="lg">
        <h3>Publish Settings</h3>
        <pds-chip label="Neutral" sentiment="neutral" />
        <pds-box>
          <pds-chip label="Neutral" sentiment="neutral" />
      ...
      <pds-box bordered direction="column" flex="none" padding="md" border-radius="lg">
...
>
  <pds-layout-row col-gap="1rem">
    <pds-box align-items="center" justify-content="center">
...
By combining the `pds-box` and `pds-layout-row` components, you can easily create a 12-column grid system. Here's an example of how to structure your layout:
...
<pds-box display="block">
  <pds-layout-row>
    <pds-box bordered size="4">
      Content for column 1
    </pds-box>
    <pds-box bordered size="8">
      Content for column 2
    </pds-box>
  </pds-layout-row>
</pds-box>
...
<pds-box display="block">
  <pds-layout-row>
    <pds-box bordered size-md="6" size-lg="4" size-xl="3">Item 1</pds-box>
    <pds-box bordered size-md="6" size-lg="4" size-xl="3">Item 2</pds-box>
    <pds-box bordered size-md="6" size-lg="4" size-xl="3">Item 3</pds-box>
  </pds-layout-row>
</pds-box>
`}>
  <pds-box display="block">
...
<pds-box display="block">
  <pds-layout-row>
    <pds-box bordered size-xs="0" size-sm="0" size-lg="6">Larger screen content</pds-box>
    <pds-box bordered size-md="6" size-lg="0">Small screen content</pds-box>
  </pds-layout-row>
</pds-box>
`}>
  <pds-box display="block">
    <pds-layout-row>
      <pds-box bordered size-xs="0" size-sm="0" size-lg="12">Larger screen content</pds-box>
      <pds-box bordered size-md="12" size-lg="0">Small screen content</pds-box>
    </pds-layout-row>
  </pds-box>
</Canvas>
...
<pds-box direction="column"  fit>
  <pds-layout-row>
    <pds-box bordered size="4">Item 1</pds-box>
    <pds-box bordered offset="4" size="4">Item 2</pds-box>
  </pds-layout-row>
  <pds-layout-row>
    <pds-box bordered size-md="4">Item 1</pds-box>
    <pds-box bordered offset-md="4" size-md="4">Item 2</pds-box>
  </pds-layout-row>
  <pds-layout-row>
    <pds-box bordered offset="3" offset-xs="2" size="6" size-xs="8">Item 1</pds-box>
  </pds-layout-row>
</pds-box>
`}>
<pds-box direction="column" fit>
...
## Nested Layouts
You can nest `pds-layout-row` and `pds-box` components to create more complex layouts. 
<Canvas mdxSource={`
<pds-box display="block">
  <pds-layout-row>
    <pds-box display="block" size-md="8">
      <pds-layout-row>
...
`}>
  <pds-box display="block">
    <pds-layout-row>
      <pds-box bordered display="block" size-md="8">
        <pds-layout-row>
          <pds-box size-xl="6">Column 1 Item 1</pds-box>
          <pds-box size-xl="6">Column 1 Item 2</pds-box>
        </pds-layout-row>
...
### 1. Columns Not Aligning Correctly
  ...
  - **Solution:** Double-check the `align-items` and `justify-content` properties on the parent `pds-layout-row` component. Ensure that the sum of the column sizes within the row is less than or equal to 12 for a 12-column grid. Colums sums greater than 12 will wrap the row to the next line.
