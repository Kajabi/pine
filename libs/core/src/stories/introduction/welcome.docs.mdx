...
import introImage from '../assets/pine-intro-img.jpg';
...
<img src={introImage} alt="Pine Design System" width="1000" height="250" style={{ maxWidth: '100%', height: 'auto', margin: '1rem 0', borderRadius: '8px'}} />
