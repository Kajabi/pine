...
export const PdsGrid = /*@__PURE__*/createReactComponent<JSX.PdsGrid, HTMLPdsGridElement>('pds-grid');
export const PdsGridCol = /*@__PURE__*/createReactComponent<JSX.PdsGridCol, HTMLPdsGridColElement>('pds-grid-col');
