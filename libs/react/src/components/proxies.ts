...
export const PdsListOption = /*@__PURE__*/createReactComponent<JSX.PdsListOption, HTMLPdsListOptionElement>('pds-list-option');
export const PdsListOptions = /*@__PURE__*/createReactComponent<JSX.PdsListOptions, HTMLPdsListOptionsElement>('pds-list-options');
export const PdsPopover = /*@__PURE__*/createReactComponent<JSX.PdsPopover, HTMLPdsPopoverElement>('pds-popover');
